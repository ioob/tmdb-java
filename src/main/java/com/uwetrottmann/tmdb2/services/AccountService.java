...
public interface AccountService {
    ...
    Single<MovieResultsPage> favoriteMovies(
            @Path("account_id") Integer accountId,
    ...
    Single<TvShowResultsPage> favoriteTvShows(
            @Path("account_id") Integer accountId,
            @Query("language") String language,
            @Query("sort_by") SortBy sortBy,
            @Query("page") Integer page
    ...
    Single<TvEpisodeResultsPage> ratedTvShowEpisodes(
            @Path("account_id") Integer accountId,
            @Query("language") String language,
            @Query("sort_by") SortBy sortBy,
            @Query("page") Integer page
    ...
    Single<MovieResultsPage> watchlistMovies(
            @Path("account_id") Integer accountId,
            @Query("language") String language,
            @Query("sort_by") SortBy sortBy,
            @Query("page") Integer page
    ...
    Single<TvShowResultsPage> watchlistTvShows(
            @Path("account_id") Integer accountId,
            @Query("language") String language,
            @Query("sort_by") SortBy sortBy,
            @Query("page") Integer page
